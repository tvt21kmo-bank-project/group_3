...
QT_MOC_LITERAL(1, 6, 27), // "resetTimerSaldostaValikkoon"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 9), // "SaldoKoti"
QT_MOC_LITERAL(4, 45, 13), // "SaldoTulostus"
QT_MOC_LITERAL(5, 59, 14), // "QNetworkReply*"
QT_MOC_LITERAL(6, 74, 5), // "reply"
QT_MOC_LITERAL(7, 80, 18) // "on_btnMenu_clicked"

    },
    "Saldo\0resetTimerSaldostaValikkoon\0\0"
    "SaldoKoti\0SaldoTulostus\0QNetworkReply*\0"
...
void Saldo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->resetTimerSaldostaValikkoon((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->SaldoKoti((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->SaldoTulostus((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Saldo::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Saldo::resetTimerSaldostaValikkoon)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Saldo::resetTimerSaldostaValikkoon(int _t1)
{
